...
public class Snapshot extends EvercamObject {
     ...
     */
    public static String getBase64DataStringFrom(String completeDataString) {
     ...
     */
    public static byte[] getDataFrom(String base64DataString) {
        if (base64DataString != null) {
            return Base64.decode(base64DataString, Base64.DEFAULT);
        }
        return null;
    }
