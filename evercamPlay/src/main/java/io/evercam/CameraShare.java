...
public class CameraShare extends EvercamObject implements CameraShareInterface {
            ...
            try {
                ...
                if (response.getStatus() == CODE_CREATE || response.getStatus() == CODE_OK) {
                    try {
                        ...
                        try {
                            jsonObject = response.getBody().getObject().getJSONArray("share_requests")
                                    .getJSONObject(0);
                        }catch (JSONException e1) {
                            throw new EvercamException(e1);
                        }
     ...
     */
    public String getSharerId() throws JSONException {
        return jsonObject.getString("sharer_id");
    }

    public String getSharerEmail() throws JSONException {
        return jsonObject.getString("sharer_email");
    }

    public String getSharerFullName() throws JSONException {
    ...
    public Right getRights() throws JSONException {
